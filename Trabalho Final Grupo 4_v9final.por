...
{	
	...
	funcao buscaAluno(cadeia tabelaAlunos[][])
	{
		...
		escreva("Nome completo do aluno que está buscando: ")
		leia (nomeBusca)
	...
	funcao aniversariantes(cadeia tabelaAlunos[][])
	{
		...
		escreva("\n\n-----------------------------------------\n\n")
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Fevereiro: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
		...
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Março: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
		...
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Abril: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
		...
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Maio: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
		...
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Junho: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
		...
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Julho: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
		...
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Agosto: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
		...
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Setembro: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
		...
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Outubro: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
		...
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Novembro: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
		...
		Util.aguarde(1000)
		escreva("Aniversariantes do mês de Dezembro: \n")
		para(inteiro linha=0 ; linha < linhas ; linha++)
		{
 ...
 * 
 * @POSICAO-CURSOR = 13; 
 * @DOBRAMENTO-CODIGO = [7, 134, 154, 161, 186, 211, 255, 316, 353, 635, 489, 642, 652, 686, 806, 842, 853, 1057];
 * @PONTOS-DE-PARADA = ;
